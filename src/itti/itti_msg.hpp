...
// class itti_msg_tun_throughput : public itti_msg {
//  public:
//   itti_msg_tun_throughput(
//       const task_id_t origin, const task_id_t destination, uint32_t timer_id,
//       uint64_t arg1_user, uint64_t arg2_user)
//       : itti_msg(THROUGHPUT_TIMER, origin, destination),
//         timer_id(timer_id),
//         arg1_user(arg1_user),
//         arg2_user(arg2_user) {}
//   itti_msg_tun_throughput(const itti_msg_tun_throughput& i)
//       : itti_msg(i),
//         timer_id(i.timer_id),
//         arg1_user(i.arg1_user),
//         arg2_user(i.arg2_user) {}
